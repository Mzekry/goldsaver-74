...
export const GoldSummary = () => {
  const { totalPurchaseValue, currentValue, isZakatEligible, zakatAmount } = useGold();
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      <Card className="card-highlight">
        <CardContent className="p-6">
          <h3 className="text-sm font-medium text-muted-foreground mb-2">Total Purchase Value</h3>
      ...
      <Card className="card-highlight">
        <CardContent className="p-6">
          <h3 className="text-sm font-medium text-muted-foreground mb-2">Zakat Calculation</h3>
          {isZakatEligible ? (
            <>
              <div className="flex items-center gap-2 mb-2">
                <CheckCircle className="h-5 w-5 text-green-600" />
                <span className="text-sm text-green-600 font-medium">Eligible for Zakat</span>
              </div>
